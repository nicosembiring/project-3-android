        ...
        NavigationRoute.builder(this)
                ...
                .getRoute(new Callback<DirectionsResponse>() {
                    ...
                    public void onResponse(Call<DirectionsResponse> call, Response<DirectionsResponse> response) {
                        ...
                        Log.d(TAG, "ResponseBK code: " + response.code());
    ...
    public void fetchDestination(){
        ...
        mApiService.getTujuan("ITOU001").enqueue(new Callback<ResponseTujuan>() {
            ...
            public void onResponse(Call<ResponseTujuan> call, retrofit2.Response<ResponseTujuan> response) {
                ...
                longitude = Double.valueOf(response.body().getData().get(0).getLongitude());
                latitude = Double.valueOf(response.body().getData().get(0).getLatitude());
